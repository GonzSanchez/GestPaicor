...
<body>
    ...
    <section id='container_lista'>
        ...
        <?php    
            //paginador
            $sql_register = mysqli_query($connection, "SELECT COUNT(*) as total_registro FROM paicor_data WHERE (nombre LIKE '%$busqueda%' 
            OR fecha LIKE '%$busqueda%' OR rubro LIKE '%$busqueda%' OR ubicación LIKE '%$busqueda%') AND ID > 0");
            ...
            $query = mysqli_query($connection ,"SELECT * FROM `paicor_data`
                                                ...
                                                OR fecha LIKE '%$busqueda%' OR ubicación 
                                                LIKE '%$busqueda%' OR rubro LIKE '%$busqueda%') AND ID > 0
                                                ORDER BY ID DESC
